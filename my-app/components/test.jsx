...
export default function Home({
  ...
  const allMatricesConsistent = () => {
    if (consistentMatrices.length == 0) return false;
    return (
      consistentMatrices.length === numberOfPrs &&
      consistentMatrices.every((matrix) => matrix === "Consistent Matrix")
    );
  };
    ...
    <div className="w-full p-10">
      <div className="font-bold text-3xl uppercase flex items-center gap-2">
        ...
        <span className="text-sm font-normal text-muted-foreground">
          ( Pairwise comparison Between subPrs )
        </span>
      </div>
      ...
      <div className="flex gap-2">
        ...
        {/* disabled={!allMatricesConsistent()} */}
      </div>
    </div>
  );
}
