...
const Step2 = ({ setCurrent, sdrs2, setSdrs2, updateTable }) => {
  ...
  const removeSDR = (indexToRemove) => {
    setSdrs2(sdrs2.filter((_, index) => index !== indexToRemove));
  };

  const handleSDRChange = (index, newName) => {
    const updatedSDRs = [...sdrs2];
    updatedSDRs[index] = { name: newName };
    setSdrs2(updatedSDRs);
